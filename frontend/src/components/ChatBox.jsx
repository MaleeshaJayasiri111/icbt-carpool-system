    ...
    const [messages, setMessages] = useState([
        {
            id: 1,
            sender: 'System',
            text: 'Welcome to the ICBT Carpool Chat. Please keep communications strictly related to the ride coordination.',
                        ...
                        >
                            <div
                                className={`p-3 rounded shadow-sm ${
                                    msg.isSelf
                                        ? 'bg-primary text-white custom-chat-self'
                                        : 'bg-white text-dark border custom-chat-other'
                                }`}
                                style={{ maxWidth: '75%' }}
                            >
                                {!msg.isSelf && (
                                ...
                                <div
                                    className={`small ${
                                        msg.isSelf
                                            ? 'text-primary-light text-end opacity-75'
                                            : 'text-muted text-end'
                                    }`}
